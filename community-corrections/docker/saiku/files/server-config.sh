...
curl -s -u admin:admin -F name="Analytics" -F file="@/tmp/CommunityCorrectionsMondrianSchema.xml;filename=CommunityCorrectionsMondrianSchema.xml;type=text/xml" http://localhost/saiku/rest/saiku/admin/schema/Analytics/
