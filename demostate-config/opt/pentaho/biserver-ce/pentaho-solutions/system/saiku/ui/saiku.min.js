...
SaikuTableRenderer.prototype.internalRender=function(a,b){var c="",d="",e=a.cellset,f=e?e:[],g,h,k,l,m,n=0,s=[],p=null,A=!1,w=!1,y=!1,x=[],B=!0;b&&(p=b.hasOwnProperty("batchSize")?b.batchSize:null,B=b.hasOwnProperty("wrapContent")?b.wrapContent:!0);var r={};r[COLUMNS]=a.rowTotalsLists;r[ROWS]=a.colTotalsLists;for(var D={},v={},w=[ROWS,COLUMNS],d=0;d<w.length;d++)D[w[d]]=[],v[w[d]]=[];if(r[COLUMNS])for(d=0;d<r[COLUMNS].length;d++)v[COLUMNS][d]=0,D[COLUMNS][d]=r[COLUMNS][d][v[COLUMNS][d]].width;for(var t=
0,G=f.length;t<G;t++){var H=t-a.topOffset;g=1;var I=w=l=h=!1;if(r[ROWS])for(d=0;d<r[ROWS].length;d++)v[ROWS][d]=0,D[ROWS][d]=r[ROWS][d][v[ROWS][d]].width;d="\x3ctr\x3e";0===t&&(d="\x3cthead\x3e"+d);for(var u=0,J=f[t].length;u<J;u++){var F=u-a.leftOffset,q=e[t][u];"COLUMN_HEADER"===q.type&&(w=!0);if("COLUMN_HEADER"===q.type&&"null"===q.value&&(null==k||u<k))d+='\x3cth class\x3d"all_null"\x3e\x26nbsp;\x3c/th\x3e';else if("COLUMN_HEADER"===q.type){null==k&&(k=u);f[t].length==u+1?l=!0:m=e[t][u+1];if(l)"null"==
q.value?d+='\x3cth class\x3d"col_null"\x3e\x26nbsp;\x3c/th\x3e':(r[ROWS]&&(g=r[ROWS][t+1][v[ROWS][t+1]].span),d+='\x3cth class\x3d"col" style\x3d"text-align: center;" colspan\x3d"'+g+'" title\x3d"'+q.value+'"\x3e'+(B?'\x3cdiv rel\x3d"'+t+":"+u+'"\x3e'+q.value+"\x3c/div\x3e":q.value)+"\x3c/th\x3e");else{var F=1<u&&1<t&&!h&&u>k?e[t-1][u+1].value!=e[t-1][u].value||e[t-1][u+1].properties.uniquename!=e[t-1][u].properties.uniquename:!1,C=999<g?!0:!1;q.value!=m.value||nextParentsDiffer(e,t,u)||h||F||C?("null"==
q.value?d+='\x3cth class\x3d"col_null" colspan\x3d"'+g+'"\x3e\x26nbsp;\x3c/th\x3e':(r[ROWS]&&(g=r[ROWS][t+1][v[ROWS][t+1]].span),d+='\x3cth class\x3d"col" style\x3d"text-align: center;" colspan\x3d"'+(0==g?1:g)+'" title\x3d"'+q.value+'"\x3e'+(B?'\x3cdiv rel\x3d"'+t+":"+u+'"\x3e'+q.value+"\x3c/div\x3e":q.value)+"\x3c/th\x3e"),g=1):g++}r[ROWS]&&(d+=genTotalHeaderCells(u-a.leftOffset+1,t+1,D[ROWS],v[ROWS],r[ROWS],B))}else if("ROW_HEADER"===q.type&&"null"===q.value)d+='\x3cth class\x3d"row_null"\x3e\x26nbsp;\x3c/th\x3e';
else if("ROW_HEADER"===q.type){n==u?h=!0:m=e[t][u+1];F=e[t-1];C=!I&&!h&&(0==u||!topParentsDiffer(e,t,u))&&q.value===F[u].value;I=!C;F=C?"\x3cdiv\x3e\x26nbsp;\x3c/div\x3e":'\x3cdiv rel\x3d"'+t+":"+u+'"\x3e'+q.value+"\x3c/div\x3e";B||(F=C?"\x26nbsp;":q.value);var C=C?"row_null":"row",E=0;if(!h&&("undefined"==typeof m||"null"===m.value)){var E=1,z=q.properties.dimension,q=q.properties.level,q=z in s?s[z].length-s[z].indexOf(q):1,z=u+1;for(;E<q&&z<=n+1&&"null"!==e[t][z];z++)E=z-u;u=u+E-1}d+='\x3cth class\x3d"'+
C+'" '+(0<E?' colspan\x3d"'+E+'"':"")+"\x3e"+F+"\x3c/th\x3e"}else if("ROW_HEADER_HEADER"===q.type)d+='\x3cth class\x3d"row_header"\x3e'+(B?"\x3cdiv\x3e"+q.value+"\x3c/div\x3e":q.value)+"\x3c/th\x3e",h=!0,n=u,q.properties.hasOwnProperty("dimension")&&(z=q.properties.dimension,z in s||(s[z]=[]),s[z].push(q.properties.level));else if("DATA_CELL"===q.type){A=!0;C="";z=q.value;E="";if(q.properties.hasOwnProperty("image"))var z=q.properties.hasOwnProperty("image_height")?" height\x3d'"+q.properties.image_height+
"'":"",K=q.properties.hasOwnProperty("image_width")?" width\x3d'"+q.properties.image_width+"'":"",z="\x3cimg "+z+" "+K+" style\x3d'padding-left: 5px' src\x3d'"+q.properties.image+"' border\x3d'0'\x3e";q.properties.hasOwnProperty("style")&&(C=" style\x3d'background-color: "+q.properties.style+"' ");q.properties.hasOwnProperty("link")&&(z="\x3ca target\x3d'__blank' href\x3d'"+q.properties.link+"'\x3e"+z+"\x3c/a\x3e");q.properties.hasOwnProperty("arrow")&&(E="\x3cimg height\x3d'10' width\x3d'10' style\x3d'padding-left: 5px' src\x3d'./images/arrow-"+
q.properties.arrow+".gif' border\x3d'0'\x3e");d+='\x3ctd class\x3d"data" '+C+"\x3e"+(B?'\x3cdiv class\x3d"datadiv" alt\x3d"'+q.properties.raw+'" rel\x3d"'+q.properties.position+'"\x3e':"")+z+E+(B?"\x3c/div\x3e":"")+"\x3c/td\x3e";r[ROWS]&&(d+=genTotalDataCells(F+1,H,D[ROWS],v[ROWS],r,B))}}d+="\x3c/tr\x3e";g="";r[COLUMNS]&&0<=H&&(g+=genTotalHeaderRowCells(H+1,D,v,r,B));A&&p?t<=p?(w||y||(c+="\x3c/thead\x3e\x3ctbody\x3e",y=!0),c+=d,0<g.length&&(c+=g)):(x.push(d),0<g.length&&x.push(g)):(w||y||(c+="\x3c/thead\x3e\x3ctbody\x3e",
y=!0),c+=d,0<g.length&&(c+=g))}b&&(b.batchResult=x,b.hasBatchResult=0<x.length);return"\x3ctable\x3e"+c+"\x3c/tbody\x3e\x3c/table\x3e"};
...
SaikuChartRenderer.prototype.process_data_tree=function(a,b,c){var d={};b&&(d.resultset=[],d.metadata=[],d.height=0,d.width=0);var e=d;if("undefined"!=typeof a&&"undefined"!=typeof a.data&&!(null!==a.data&&null!==a.data.error||null===a.data||a.data.cellset&&0===a.data.cellset.length)){var f=a.data.cellset;if(f&&0<f.length){var g=0,h=0,k=!1,l,m,n,s=function(a,b){return a+b};l=0;for(m=f.length;0===h&&l<m;l++)for(var p=0,A=f[l].length;p<A;p++){if(!k)for(;"COLUMN_HEADER"==f[l][p].type&&"null"==f[l][p].value;)l++;
k=!0;if("ROW_HEADER_HEADER"==f[l][p].type){for(;"ROW_HEADER_HEADER"==f[l][p].type;)b&&d.metadata.push({colIndex:p,colType:"String",colName:f[l][p].value}),p++;g=p-1}if("COLUMN_HEADER"==f[l][p].type){h=0;for(n=[];h<=l;)"null"!==f[h][p].value&&n.push(f[h][p].value),h++;b&&d.metadata.push({colIndex:p,colType:"Numeric",colName:n.join(" ~ ")});h=l+1}}k=[];for(n=0;n<=g;n++)k.push(null);l=h;for(m=f.length;l<m;l++)if(""!==f[l][0].value){A=[];n=[];p=h=null;for(n=0;n<=g;n++){if(f[l]&&"null"===f[l][n].value){for(var e=
d,w=0;w<g&&"null"===f[l][w].value;w++)e=e[k[w]];w>n&&(n=w)}if(f[l]&&"null"!==f[l][n].value){if(0===n)for(w=0;w<=g;w++)k[w]=null;"number"==typeof e&&(h[p]={},e=h[p]);p=f[l][n].value;k[n]=p;e.hasOwnProperty(p)||(e[p]={});h=e;e=e[p]}}n=_.clone(k);e=g+1;for(w=f[l].length;e<w;e++){var y=f[l][e],x=y.value||0,B=0!==x,r=y.properties.raw;r&&"null"!==r?x=parseFloat(r):"number"!==typeof y.value&&parseFloat(y.value.replace(/[^a-zA-Z 0-9.]+/g,""))&&(x=parseFloat(y.value.replace(/[^a-zA-Z 0-9.]+/g,"")),B=!1);0<
x&&B&&(x=y.value&&0<=y.value.indexOf("%")?100*x:x);A.push(x);n.push({f:y.value,v:x})}b&&d.resultset.push(n);e=_.reduce(A,s,0);p=null===p?"null":p;h[p]=e;e=d}c&&(this.rawdata=a.data,this.data=d,this.hasProcessed=!0,this.data.height=this.data.resultset.length);return d}$(this.el).find(".canvas_wrapper").text("No results").show()}};
...
$(a.target).parent().parent().attr("hierarchycaption");var d=$(a.target).attr("level"),e="ROWS",e=0<$(this.workspace.el).find(".workspace_fields ul.hierarchy[hierarchy\x3d'"+c+"']").length?$(this.workspace.el).find(".workspace_fields ul[hierarchy\x3d'"+c+"'] a[level\x3d'"+d+"']").parent().show().parents(".fields_list_body").hasClass("rows")?"ROWS":"COLUMNS":(0<$(this.workspace.el).find(".workspace_fields .fields_list[title\x3d'ROWS'] ul.hierarchy").length?$(this.workspace.el).find(".workspace_fields .fields_list[title\x3d'COLUMNS'] ul.connectable"):
$(this.workspace.el).find(".workspace_fields .fields_list[title\x3d'ROWS'] ul.connectable")).parents(".fields_list").attr("title");this.workspace.query.helper.includeLevel(e,c,d);Saiku.session.trigger("dimensionList:select_dimension",{workspace:this.workspace});this.workspace.sync_query();this.workspace.query.run();a.preventDefault();return!1}},select_measure:function(a,b){if(!$(a.target).parent().hasClass("ui-state-disabled")){var c=$(a.target).parent().clone(),c={name:c.find("a").attr("measure"),
type:c.find("a").attr("type")};this.workspace.query.helper.includeMeasure(c);this.workspace.sync_query();this.workspace.query.run();a.preventDefault();return!1}},measure_dialog:function(a,b){(new MeasuresModal({workspace:this.workspace,measure:null})).render().open()}}),Toolbar=Backbone.View.extend({tagName:"div",events:{"click a":"call"},template:function(){return _.template($("#template-toolbar").html())(this)},initialize:function(){this.render()},render:function(){$(this.el).attr("id","toolbar").html(this.template());
Saiku.events.trigger("toolbar:render",{toolbar:this});return this},call:function(a){var b=$(a.target).attr("href").replace("#","");if(this[b])this[b](a);a.preventDefault()},new_query:function(){Saiku.tabs.add(new Workspace);return!1},open_query:function(){var a=_.find(Saiku.tabs._tabs,function(a){return a.content instanceof OpenQuery});a?a.select():Saiku.tabs.add(new OpenQuery);return!1},logout:function(){Saiku.session.logout()},about:function(){(new AboutModal).render().open();return!1},issue_tracker:function(){window.open("http://jira.meteorite.bi/");
return!1},help:function(){window.open("http://wiki.meteorite.bi/display/SAIK/Saiku+Documentation");return!1}}),Upgrade=Backbone.View.extend({tagName:"div",events:{},initialize:function(a,b){this.workspace=a.workspace},daydiff:function(a,b){return Math.round((b-a)/864E5)},render:function(){return this;},call:function(a){}}),Modal=Backbone.View.extend({tagName:"div",
...
b){var c=$(b).attr("rel");c&&e.push(c)});$(b.workspace.el).find(".workspace_results").find(".ui-selected").removeClass(".ui-selected");e=_.uniq(e);0<e.length&&b.workspace.query.action.put("/zoomin",{success:function(a,c){b.workspace.query.parse(c);b.workspace.unblock();b.workspace.sync_query();Saiku.ui.unblock();b.workspace.query.run()},data:{selections:JSON.stringify(e)}})}});$(this.workspace.el).find(".drillthrough, .drillthrough_export, .query_scenario, .drillacross").removeClass("on")}},query_scenario:function(a){$(a.target).toggleClass("on");
this.check_modes($(a.target))},zoom_mode:function(a){$(a.target).toggleClass("on");this.check_modes($(a.target))},drillacross:function(a){$(a.target).toggleClass("on");this.check_modes($(a.target))},drillthrough:function(a){$(a.target).toggleClass("on");this.check_modes($(a.target))},display_drillthrough:function(a,b){this.workspace.table.render({data:b});Saiku.ui.unblock()},export_drillthrough:function(a){$(a.target).toggleClass("on");this.check_modes($(a.target))},clicked_cell_drillacross:function(a){$target=
$(a.target).hasClass("data")?$(a.target).find("div"):$(a.target);a=$target.attr("rel");(new DrillAcrossModal({workspace:this.workspace,title:"Drill Across",action:"export",position:a,query:this.workspace.query})).open()},clicked_cell_drillthrough_export:function(a){$target=$(a.target).hasClass("data")?$(a.target).find("div"):$(a.target);a=$target.attr("rel");(new DrillthroughModal({workspace:this.workspace,maxrows:1E4,title:"Drill-Through to CSV",action:"export",position:a,query:this.workspace.query})).open()},
clicked_cell_drillthrough:function(a){$target=$(a.target).hasClass("data")?$(a.target).find("div"):$(a.target);a=$target.attr("rel");(new DrillthroughModal({workspace:this.workspace,maxrows:200,title:"Drill-Through",action:"table",success:this.display_drillthrough,position:a,query:this.workspace.query})).open()},swap_axes_on_dropzones:function(a,b){this.workspace.query.parse(b);this.workspace.unblock();this.workspace.sync_query();Saiku.ui.unblock();this.workspace.unblock();this.workspace.sync_query();
Saiku.ui.unblock()},show_mdx:function(a){(new MDXModal({mdx:this.workspace.query.model.mdx})).render().open()},export_xls:function(a){void 0!=this.workspace.query.name?(a=this.workspace.query.name.substring(this.workspace.query.name.lastIndexOf("/")+1).slice(0,-5),window.location=Settings.REST_URL+this.workspace.query.url()+"/export/xls/"+this.workspace.query.getProperty("saiku.olap.result.formatter")+"?exportname\x3d"+encodeURIComponent(a)+"xls"):window.location=Settings.REST_URL+this.workspace.query.url()+
"/export/xls/"+this.workspace.query.getProperty("saiku.olap.result.formatter")},export_csv:function(a){void 0!=this.workspace.query.name?(a=this.workspace.query.name.substring(this.workspace.query.name.lastIndexOf("/")+1).slice(0,-6),window.location=Settings.REST_URL+this.workspace.query.url()+"/export/csv/"+this.workspace.query.getProperty("saiku.olap.result.formatter")+"?exportname\x3d"+encodeURIComponent(a)):window.location=Settings.REST_URL+this.workspace.query.url()+"/export/csv/"+this.workspace.query.getProperty("saiku.olap.result.formatter")},
export_pdf:function(a){void 0!=this.workspace.query.name?(a=this.workspace.query.name.substring(this.workspace.query.name.lastIndexOf("/")+1).slice(0,-6),window.location=Settings.REST_URL+this.workspace.query.url()+"/export/pdf/"+this.workspace.query.getProperty("saiku.olap.result.formatter")+"?exportname\x3d"+encodeURIComponent(a)):window.location=Settings.REST_URL+this.workspace.query.url()+"/export/pdf/"+this.workspace.query.getProperty("saiku.olap.result.formatter")},switch_to_mdx:function(a){var b=
this;$(this.workspace.el).find(".workspace_fields").addClass("hide");$(this.el).find(".auto, .query_scenario, .buckets, .non_empty, .swap_axis, .mdx, .switch_to_mdx, .zoom_mode, .drillacross").parent().hide();0<$(this.workspace.el).find(".workspace_results tbody.ui-selectable").length&&$(this.workspace.el).find(".workspace_results tbody").selectable("destroy");$(this.el).find(".run").attr("href","#run_mdx");$(this.el).find(".run, .save, .open, .new, .edit").removeClass("disabled_toolbar");if("view"!=
Settings.MODE&&"table"!=Settings.MODE&&!this.workspace.isReadOnly){$mdx_editor=$(this.workspace.el).find(".mdx_input");$(this.workspace.el).find(".workspace_editor .mdx_input, .workspace_editor .editor_info, .workspace_editor").removeClass("hide").show();this.editor=ace.edit("mdx_editor");this.editor.setShowPrintMargin(!1);this.editor.setFontSize(11);this.editor.commands.addCommand({name:"runmdx",bindKey:{win:"Ctrl-Enter",mac:"Command-Enter"},exec:function(a){b.run_mdx()},readOnly:!0});a=function(){var a=
b.editor.getCursorPosition();$mdx_editor.parent().find(".editor_info").html("\x26nbsp; "+(a.row+1)+", "+a.column)};this.editor.on("changeSelection",a);a();var c=function(){var a=$(document).height()/3,a=Math.floor(a/b.editor.renderer.lineHeight),a=((b.editor.getSession().getScreenLength()>a?a:b.editor.getSession().getScreenLength())+1)*b.editor.renderer.lineHeight+b.editor.renderer.scrollBar.getWidth();$mdx_editor.height(a.toString()+"px");b.editor.resize();b.workspace.adjust()};a=function(){var a=
b.editor.session;b.editor.resize();a.setUseWrapMode(!0);if(a.getUseWrapMode()){var c=b.editor.renderer.characterWidth,f=b.editor.renderer.scroller.clientWidth;0<f&&a.setWrapLimitRange(null,parseInt(f/c,10))}};a();c();b.editor.focus();b.editor.clearSelection();b.editor.getSession().setValue("");b.editor.getSession().on("change",c);$(window).resize(a);b.editor.on("changeSelection",c);b.editor.on("focus",function(a){c();return!0});b.editor.on("blur",function(a){100<$(b.workspace.el).find(".mdx_input").height()&&
$(b.workspace.el).find(".mdx_input").height(100);b.editor.resize();b.workspace.adjust();return!0});this.editor.getSession().setMode("ace/mode/text")}this.workspace.dimension_list&&$(this.workspace.el).find(".sidebar_inner ul li a").css({fontWeight:"normal"}).parent("li").removeClass("ui-draggable ui-draggable-disabled ui-state-disabled");this.activate_buttons({workspace:this.workspace});$(this.workspace.toolbar.el).find(".run").removeClass("disabled_toolbar");$(this.workspace.table.el).empty();this.workspace.adjust();
this.post_mdx_transform()},post_mdx_transform:function(){var a=this;"MDX"!==this.workspace.query.model.type&&(this.workspace.query.model.queryModel={},this.workspace.query.model.type="MDX",this.workspace.query.setProperty("saiku.olap.result.formatter","flat"),a.workspace.query.helper.model().parameters={});var b=this.workspace.query.model.mdx;a.editor&&(a.editor.setValue(b,0),a.editor.clearSelection(),a.editor.focus());$(a.el).find(".group_parents").removeClass("on");if(Settings.ALLOW_PARAMETERS){var c=
function(){var b=a.editor.getValue(),c=[];if(b)for(var f=0,g=b.length;f<g-1;f++)if("$"===b[f]&&"{"===b[f+1]){for(var h="",k=!1,f=f+2;f<g;f++)if("}"!==b[f])h+=b[f];else{k=!0;f++;break}k&&h&&0<h.length&&c.push(h)}var l=a.workspace.query.helper.model().parameters,m={};_.each(c,function(a){m[a]=l[a]?l[a]:""});a.workspace.query.helper.model().parameters=m;a.workspace.update_parameters()},b=function(){_.delay(c,1E3)};a.editor&&(a.editor.getSession().off("change",b),a.editor.getSession().on("change",b));
a.workspace.update_parameters()}},run_mdx:function(a){100<$(this.workspace.el).find(".mdx_input").height()&&$(this.workspace.el).find(".mdx_input").height(100);this.editor.resize();a=this.editor.getValue();this.workspace.query.model.mdx=a;this.workspace.query.run(!0)},explain_query:function(a){this.workspace.query.action.gett("/explain",{success:function(a,c){var d="\x3ctextarea style\x3d'width: "+($("body").width()-165)+"px;height:"+($("body").height()-175)+"px;'\x3e",d=null!==c&&null!==c.error?
d+c.error:c.cellset&&0===c.cellset.length?d+"Empty explain plan!":d+c.cellset[1][0].value,d=d+"\x3c/textarea\x3e";Saiku.ui.unblock();$.fancybox('\x3cdiv id\x3d"fancy_results" class\x3d"workspace_results" style\x3d"overflow:visible"\x3e\x3ctable\x3e\x3ctr\x3e\x3cth clas\x3d"row_header"\x3eExplain Plan\x3c/th\x3e\x3c/tr\x3e\x3ctr\x3e\x3ctd\x3e'+d+"\x3c/td\x3e\x3c/tr\x3e\x3c/table\x3e\x3c/div\x3e",{autoDimensions:!1,autoScale:!1,height:$("body").height()-100,width:$("body").width()-100,transitionIn:"none",
transitionOut:"none"})}});return!1}}),WorkspaceDropZone=Backbone.View.extend({template:function(){var a=$("#template-workspace-dropzones").html()||"";return _.template(a)()},events:{"sortstop .fields_list_body.details":"set_measures","sortstop .axis_fields":"select_dimension","click .d_measure":"remove_measure_click","click .d_level":"selections","click .measure_fields.limit":"measure_action","click .axis_fields_header.limit":"limit_axis","click .clear_axis":"clear_axis"},initialize:function(a){this.workspace=
a.workspace;_.bindAll(this,"clear_axis")},render:function(){var a=this;$(this.el).html(this.template());$(this.el).find(".fields_list_body.details ul.connectable").sortable({items:"\x3e li",opacityg:.6,placeholder:"placeholder",tolerance:"pointer",containment:$(a.workspace.el),start:function(a,c){c.placeholder.text(c.helper.text())}});$(this.el).find(".axis_fields ul.connectable").sortable({connectWith:$(a.el).find(".axis_fields ul.connectable"),forcePlaceholderSize:!1,forceHelperSize:!0,items:"li.selection",
opacity:.6,placeholder:"placeholder",tolerance:"touch",cursorAt:{top:10,left:60},containment:$(a.workspace.el),start:function(b,c){var d=$(c.helper).find("a").parent().parent().attr("hierarchycaption");c.placeholder.text(d);$(c.helper).css({width:"auto",height:"auto"});$(a.el).find(".axis_fields ul.hierarchy li.d_level:visible").addClass("temphide").hide()}});return this},set_measures:function(a,b){var c=[];$(this.el).find(".fields_list_body.details ul.connectable li.d_measure").each(function(a,b){var f=
{name:$(b).find("a").attr("measure"),type:$(b).find("a").attr("type")};c.push(f)});this.workspace.query.helper.setMeasures(c);this.workspace.sync_query();this.workspace.query.run()},remove_measure_click:function(a){a.preventDefault();($(a.target).hasClass("d_measure")?$(a.target).find("a"):$(a.target)).parent().remove();this.set_measures()},remove_dimension:function(a,b){if($(b.helper).hasClass("d_measure"))$(b.helper).detach(),this.set_measures();else{var c=$(b.helper).find("a").attr("hierarchy");
...
{name:a+"."+b});d.level=_.findWhere(d.hierarchies.levels,{name:c});if(null===d.level||void 0===d.level)d.level=_.findWhere(d.hierarchies.levels,{caption:c});return d},selections:function(a,b){a&&a.preventDefault();var c=$(a.target).hasClass("d_level")?$(a.target).find(".level"):$(a.target),d=c.attr("hierarchy").replace(/[\[\]]/gi,"").split(".")[0],e=c.attr("hierarchy").replace(/[\[\]]/gi,"").split(".")[1]?c.attr("hierarchy").replace(/[\[\]]/gi,"").split(".")[1]:c.attr("hierarchy").replace(/[\[\]]/gi,
"").split(".")[0],f=c.text(),g=this.find_type_time(d,e,f),h=c.attr("hierarchy"),k=c.attr("href").replace("#","");this.member=new Member({},{cube:this.workspace.selected_cube,dimension:k});var l=decodeURIComponent(this.member.hierarchy),l=this.workspace.query.helper.getHierarchy(l),m;l&&l.levels.hasOwnProperty(f)&&(m=l.levels[f]);void 0===g.level.annotations||null===g.level.annotations||void 0===g.level.annotations.AnalyzerDateFormat&&void 0===g.level.annotations.SaikuDayFormatString||0!==m.selection.members.length?
(new SelectionsModal({target:c,name:c.text(),key:k,workspace:this.workspace})).open():(new DateFilterModal({dimension:d,hierarchy:e,target:c,name:c.text(),data:g,analyzerDateFormat:g.level.annotations.AnalyzerDateFormat,dimHier:h,key:k,workspace:this.workspace})).open();return!1},measure_action:function(a){var b=this;if("undefined"==typeof this.workspace.query||"QUERYMODEL"!=this.workspace.query.model.type||"view"==Settings.MODE)return!1;a=$(a.target).hasClass("limit")?$(a.target):$(a.target).parent();
var c={HEADER:{name:"Position",disabled:!0,i18n:!0},sep1:"---------",BOTTOM_COLUMNS:{name:"Columns | Measures",i18n:!0},TOP_COLUMNS:{name:"Measures | Columns",i18n:!0},BOTTOM_ROWS:{name:"Rows | Measures",i18n:!0},TOP_ROWS:{name:"Measures | Rows",i18n:!0},sep2:"---------",reset:{name:"Reset Default",i18n:!0},cancel:{name:"Cancel",i18n:!0}};$.each(c,function(a,b){recursive_menu_translate(b,Saiku.i18n.po_file)});$.contextMenu("destroy",".limit");$.contextMenu({appendTo:a,selector:".limit",ignoreRightClick:!0,
build:function(a,e){var f=b.workspace.query;return{callback:function(a,b){var c=f.helper.model().queryModel.details;if("cancel"!==a){if("reset"===a)c.location=SaikuOlapQueryTemplate.queryModel.details.location,c.axis=SaikuOlapQueryTemplate.queryModel.details.axis;else{var d=a.split("_")[0],e=a.split("_")[1];c.location=d;c.axis=e}f.run()}},items:c}}});a.contextMenu()},limit_axis:function(a){var b=this;if("undefined"==typeof this.workspace.query||"QUERYMODEL"!=this.workspace.query.model.type||"view"==
Settings.MODE)return!1;var c=$(a.target).hasClass("limit")?$(a.target):$(a.target).parent(),d=c.siblings(".fields_list_body").parent().attr("title");$.contextMenu("destroy",".limit");$.contextMenu({appendTo:c,selector:".limit",ignoreRightClick:!0,build:function(a,f){var g={},h=Saiku.session.sessionworkspace.cube[b.workspace.selected_cube].get("data").measures,k=b.workspace.query.helper.getAxis(d),l,m,n,s,p,A,w,y,x,B=!1,r=!1,D=!1;k&&k.filters&&_.each(k.filters,function(a){"N"==a.flavour&&(l=k["function"],
m=a.expressions[0],n=a.expressions[1],D=!0);"Generic"==a.flavour&&(s=a.expressions[0],B=!0)});k&&k.sortOrder&&(p=k.sortOrder,A=k.sortEvaluationLiteral,r=!0);k&&k.aggregators&&0<k.aggregators.length&&(x=k.aggregators[0]);null!==l&&null===n?y=l+"###SEPARATOR###"+m:null!==l&&null!==n&&null!==m&&(y="custom");r&&null!==p&&(w="customsort");_.each(h,function(a){g[a.uniqueName]={name:a.caption,payload:{n:10,sortliteral:a.uniqueName}}});_.each(k.hierarchies,function(a){for(var b in a.levels)console.log(b)});
var v=function(a,b){var c={},d;for(d in a)c[b+"###SEPARATOR###"+d]=_.clone(a[d]),c[b+"###SEPARATOR###"+d].fun=b,b==l&&n==d&&a[d].payload.n==m&&(y=b+"Quick",c[b+"###SEPARATOR###"+d].name="\x3cb\x3e"+a[d].name+"\x3c/b\x3e"),b==p&&A==d&&(w=b+"Quick",c[b+"###SEPARATOR###"+d].name="\x3cb\x3e"+a[d].name+"\x3c/b\x3e");return c},v={filter:{name:"Filter",i18n:!0,items:{customfilter:{name:"Custom...",i18n:!0},clearfilter:{name:"Clear Filter",i18n:!0}}},limit:{name:"Limit",i18n:!0,items:{"TopCount###SEPARATOR###10":{name:"Top 10",
i18n:!0},"BottomCount###SEPARATOR###10":{name:"Bottom 10",i18n:!0},TopCountQuick:{name:"Top 10 by...",i18n:!0,items:v(g,"TopCount")},BottomCountQuick:{name:"Bottom 10 by...",i18n:!0,items:v(g,"BottomCount")},customtop:{name:"Custom Limit...",i18n:!0},clearlimit:{name:"Clear Limit",i18n:!0}}},sort:{name:"Sort",i18n:!0,items:{ASCQuick:{name:"Ascending",i18n:!0,items:v(g,"ASC")},DESCQuick:{name:"Descending",i18n:!0,items:v(g,"DESC")},BASCQuick:{name:"Ascending (Breaking Hierarchy)",i18n:!0,items:v(g,
"BASC")},BDESCQuick:{name:"Descending (Breaking Hierarchy)",i18n:!0,items:v(g,"BDESC")},customsort:{name:"Custom...",i18n:!0},clearsort:{name:"Clear Sort",i18n:!0}}},grand_totals:{name:"Grand totals",i18n:!0,items:{show_totals_not:{name:"None",i18n:!0},show_totals_sum:{name:"Sum",i18n:!0},show_totals_min:{name:"Min",i18n:!0},show_totals_max:{name:"Max",i18n:!0},show_totals_avg:{name:"Avg",i18n:!0}}},cancel:{name:"Cancel",i18n:!0}};$.each(v,function(a,b){recursive_menu_translate(b,Saiku.i18n.po_file)});
var t=v.grand_totals.items;if(x)for(var G in t)G.substring(12)==x&&(t[G].name="\x3cb\x3e"+t[G].name+"\x3c/b");else t.show_totals_not.name="\x3cb\x3e"+t.show_totals_not.name+"\x3c/b";g["10"]={payload:{n:10}};B&&(x=v.filter,x.name="\x3cb\x3e"+x.name+"\x3c/b\x3e",x.items.customfilter.name="\x3cb\x3e"+x.items.customfilter.name+"\x3c/b\x3e");r&&(r=v.sort.items,v.sort.name="\x3cb\x3e"+v.sort.name+"\x3c/b\x3e",w in r&&(r[w].name="\x3cb\x3e"+r[w].name+"\x3c/b\x3e"));D&&(r=v.limit.items,v.limit.name="\x3cb\x3e"+
v.limit.name+"\x3c/b\x3e",y in r&&(r[y].name="\x3cb\x3e"+r[y].name+"\x3c/b\x3e"));return{callback:function(a,e){var f;if("cancel"!=a)if("clearfilter"==a)c.removeClass("on"),b.workspace.query.helper.removeFilter(k,"Generic"),b.synchronize_query(),b.workspace.query.run();else if("customfilter"==a)f=function(a){var c=[];c.push(a);b.workspace.query.helper.removeFilter(k,"Generic");k.filters.push({flavour:"Generic",operator:null,"function":"Filter",expressions:c});b.synchronize_query();b.workspace.query.run()},
(new FilterModal({axis:d,success:f,query:b.workspace.query,expression:s,expressionType:"Filter"})).render().open();else if("clearlimit"==a)c.removeClass("on"),b.workspace.query.helper.removeFilter(k,"N"),b.synchronize_query(),b.workspace.query.run();else if("customtop"==a)f=function(a,c,d){var e=[];e.push(c);d&&e.push(d);b.workspace.query.helper.removeFilter(k,"N");k.filters.push({flavour:"N",operator:null,"function":a,expressions:e});b.synchronize_query();b.workspace.query.run()},(new CustomFilterModal({axis:d,
measures:h,success:f,query:b.workspace.query,func:l,n:m,sortliteral:n})).render().open();else if("customsort"==a)f=function(a,c){k.sortOrder=a;k.sortEvaluationLiteral=c;b.synchronize_query();b.workspace.query.run()},(new FilterModal({axis:d,success:f,query:b.workspace.query,expression:A,expressionType:"Order"})).render().open();else{if("clearsort"==a)k.sortOrder=null,k.sortEvaluationLiteral=null,alert("maybe?"),b.synchronize_query();else if(0===a.indexOf("show_totals_")){f=a.substring(12);var p=[];
p.push(f);k.aggregators=p}else{f=a.split("###SEPARATOR###")[0];var r=a.split("###SEPARATOR###")[1];-1<_.indexOf(["ASC","BASC","DESC","BDESC"],f)?(k.sortOrder=f,k.sortEvaluationLiteral=g[r].payload.sortliteral):-1<_.indexOf(["Param"],f)?(console.log("here"),k.sortEvaluationLiteral=g[r].payload.sortliteral):(p=[],p.push(g[r].payload.n),(r=g[r].payload.sortliteral)&&p.push(r),b.workspace.query.helper.removeFilter(k,"N"),k.filters.push({flavour:"N",operator:null,"function":f,expressions:p}));b.synchronize_query()}b.workspace.query.run()}},
items:v}}});c.contextMenu()}}),Table=Backbone.View.extend({className:"table_wrapper",events:{"click th.row":"clicked_cell","click th.col":"clicked_cell"},initialize:function(a){this.workspace=a.workspace;this.renderer=new SaikuTableRenderer;_.bindAll(this,"render","process_data");this.workspace.bind("query:result",this.render);this.id=_.uniqueId("table_");$(this.el).attr("id",this.id)},clicked_cell:function(a){return!1},render:function(a,b){"undefined"==typeof a||"undefined"==typeof a.data||$(this.workspace.el).is(":visible")&&
!$(this.el).is(":visible")||null!==a.data&&null!==a.data.error||null===a.data||a.data.height&&0===a.data.height||(this.clearOut(),$(this.el).html("Rendering "+a.data.width+" columns and "+a.data.height+" rows..."),_.delay(this.process_data,2,a.data))},clearOut:function(){this.renderer.clear();$(this.workspace.el).find(".workspace_results").unbind("scroll");var a=document.getElementById(this.id),b=a.firstChild;b&&a.removeChild(b)},process_data:function(a){this.workspace.processing.hide();this.workspace.adjust();
this.clearOut();$(this.el).html("\x3ctable\x3e\x3c/table\x3e");this.renderer.render(a,{htmlObject:$(this.el).find("table"),batch:Settings.TABLE_LAZY,batchSize:Settings.TABLE_LAZY_SIZE,batchIntervalSize:Settings.TABLE_LAZY_LOAD_ITEMS,batchIntervalTime:Settings.TABLE_LAZY_LOAD_TIME});this.post_process()},post_process:function(){"QM"==this.workspace.query.get("type")&&"view"!=Settings.MODE?$(this.el).addClass("headerhighlight"):$(this.el).removeClass("headerhighlight");$(this.el).find(".i18n").i18n(Saiku.i18n.po_file);
...
function(d){_.each(d.schemas,function(e){0<e.cubes.length&&_.each(e.cubes,function(f){if("undefined"===typeof f.visible||f.visible){var g=""===e.name||null===e.name?"null":e.name;f=""===f.caption||null===f.caption?f.name:f.caption;a.schema===g&&a.cube===f&&(b.selected_cube=c.name+"/"+d.name+"/"+g+"/"+f,b.isUrlCubeNavigation=!0,_.delay(b.new_query,1E3))}})})})})},new_query:function(){this.query&&(this.query.destroy(),this.query.clear(),this.query.name&&(this.query.name=void 0,this.update_caption(!0)),
this.query.name=void 0);this.clear();this.processing.hide();Saiku.session.trigger("workspace:clear",{workspace:this});this.selected_cube=$(this.el).find(".cubes").val()?$(this.el).find(".cubes").val():this.selected_cube;if(!this.selected_cube)return $(this.el).find(".calculated_measures, .addMeasure").hide(),$(this.el).find(".dimension_tree").html(""),$(this.el).find(".measure_tree").html(""),!1;this.metadata=Saiku.session.sessionworkspace.cube[this.selected_cube];for(var a=this.selected_cube.split("/"),
b=a[3],c=4,d=a.length;c<d;c++)b+="/"+a[c];this.query=new Query({cube:{connection:a[0],catalog:a[1],schema:"null"==a[2]?"":a[2],name:decodeURIComponent(b)}},{workspace:this});this.query.save({},{data:{json:JSON.stringify(this.query.model)},async:!1});this.init_query()},init_query:function(a){var b=this;try{var c=this.query.model.properties?this.query.model.properties:{},d="RENDER_MODE"in Settings?Settings.RENDER_MODE:"saiku.ui.render.mode"in c?c["saiku.ui.render.mode"]:null,e="RENDER_TYPE"in Settings?
Settings.RENDER_TYPE:"saiku.ui.render.type"in c?c["saiku.ui.render.type"]:null;"table"==Settings.MODE?d="table":"chart"==Settings.MODE&&(d="chart");"undefined"!=typeof d&&null!==d&&this.querytoolbar.switch_render(d);"chart"==d?($(this.chart.el).find(".canvas_wrapper").hide(),this.chart.renderer.switch_chart(e),$(this.querytoolbar.el).find('ul.chart [href\x3d"#'+e+'"]').parent().siblings().find(".on").removeClass("on"),$(this.querytoolbar.el).find('ul.chart [href\x3d"#'+e+'"]').addClass("on")):"table"==
d&&e in this.querytoolbar&&(this.querytoolbar.render_mode="table",this.querytoolbar.spark_mode=e,$(this.querytoolbar.el).find("ul.table a."+e).addClass("on"))}catch(f){Saiku.error(this.cid,f)}"table"==Settings.MODE&&this.query?this.query.run(!0):("MDX"==this.query.model.type?(this.query.setProperty("saiku.olap.result.formatter","flat"),$(this.el).find(".sidebar").hasClass("hide")||this.toggle_sidebar(),$(this.el).find(".workspace_fields").addClass("hide"),this.toolbar.switch_to_mdx()):($(this.el).find(".workspace_editor").removeClass("hide").show(),
...
d.length&&$(this.el).find(".add_folder").parent().removeClass("hide")}catch(g){}var d=$(this.el).find(".workspace_results").html("\x3ch3\x3e\x3cstrong\x3e"+c.name+"\x3c/strong\x3e\x3c/h3\x3e"),d=$('\x3cul id\x3d"query_info" /\x3e').appendTo(d),h;for(h in c)c.hasOwnProperty(h)&&"name"!=h&&d.append($("\x3cli /\x3e").html("\x3cstrong\x3e"+h+"\x3c/strong\x3e : "+c[h]));this.selected_query=new SavedQuery({file:a,name:b,type:c.type});return!1},view_folder:function(a){var b=$(a.currentTarget).children("div").children("a");
...
this.content.append($(a.content.el))},remove:function(a){for(var b=0,c=this._tabs.length;b<c;b++)this._tabs[b]==a&&(this._tabs.splice(b,1),Saiku.session.trigger("tab:remove",{tab:a}),this.pager.render(),this._tabs[this._tabs[b]?b:this._tabs.length-1].select());return!0},close_others:function(a){var b=_.indexOf(this._tabs,a);this._tabs[b].select();for(b=0;1<this._tabs.length;)this._tabs[b]!=a?this._tabs[b].remove():b++},close_all:function(){for(var a=0,b=this._tabs.length;a<b;a++)this._tabs[a].remove()},
togglePager:function(){$(this.pager.el).toggle();return!1},new_tab:function(){this.add(new Workspace);this._tabs[this._tabs.length-1].select();return!1},duplicate:function(a){Saiku.ui.block("Duplicating tab...");a.content.query?this.add(new Workspace({query:new Query({json:JSON.stringify(a.content.query.model)},Settings.PARAMS),viewState:a.content.viewState})):this.add(new Workspace);Saiku.ui.unblock();return!1}}),RepositoryUrl="api/repository",repoPathUrl=function(){return Settings.BIPLUGIN?"pentaho/repository":
RepositoryUrl},RepositoryObject=Backbone.Model.extend({url:function(){return repoPathUrl()+"/resource"}}),RepositoryAclObject=Backbone.Model.extend({url:function(){return repoPathUrl()+"/resource/acl"},parse:function(a){"OK"!=a&&_.extend(this.attributes,a)}}),RepositoryZipExport=Backbone.Model.extend({url:function(){return repoPathUrl()+"/zip"}}),SavedQuery=Backbone.Model.extend({parse:function(a){},url:function(){return repoPathUrl()+"/resource"},move_query_to_workspace:function(a,b){var c=b,d=a.get("file"),
e;for(e in Settings)if("PARAM"==e.match("^PARAM"))var f=e.substring(5,e.length),g=new RegExp("\\$\\{"+f+"\\}","g"),f=new RegExp("\\$\\{"+f.toLowerCase()+"\\}","g"),c=c.replace(g,Settings[e]),c=c.replace(f,Settings[e]);c=new Query({xml:c,formatter:Settings.CELLSET_FORMATTER},{name:d});Saiku.tabs.add(new Workspace({query:c}))}}),Repository=Backbone.Collection.extend({model:SavedQuery,file:null,initialize:function(a,b){b&&b.dialog&&(this.dialog=b.dialog)},parse:function(a){this.dialog&&this.dialog.populate(a);
return a},url:function(){var a=repoPathUrl()+"?type\x3dsaiku";Settings.REPO_BASE&&!this.file&&(a+="\x26path\x3d"+Settings.REPO_BASE);return a}}),Result=Backbone.Model.extend({result:null,firstRun:!1,initialize:function(a,b){this.query=b.query},parse:function(a){this.query.workspace.unblock();this.query.workspace.processing.hide();this.result=a;a.error||(this.query.model=_.extend({},a.query));this.firstRun=!0;this.query.workspace.trigger("query:result",{workspace:this.query.workspace,data:a})},hasRun:function(){return this.firstRun},
lastresult:function(){return this.result},url:function(){return"api/query/execute"}}),QueryAction=Backbone.Model.extend({initialize:function(a,b){this.query=b.query;this.url=this.query.url},gett:function(a,b){this.handle("fetch",a,b)},post:function(a,b){this.handle("save",a,b)},put:function(a,b){this.id=_.uniqueId("queryaction_");this.handle("save",a,b);delete this.id},del:function(a,b){this.id=_.uniqueId("queryaction_");this.handle("delete",a,b);delete this.id},handle:function(a,b,c){this.url=this.query.url()+
b;this.attributes=c.data?c.data:{};"save"==a?this.save({},c):"delete"==a?(this.set("id",this.id),this.destroy(c)):"fetch"==a&&(this.parse=function(){},this.fetch(c))}}),QueryScenario=Backbone.Model.extend({initialize:function(a,b){_.bindAll(this,"attach_listeners","activate","clicked_cell","save_writeback","cancel_writeback","check_input");this.query=b.query},activate:function(){$(this.query.workspace.el).find("td.data").unbind("click").addClass("cellhighlight").click(this.clicked_cell)},attach_listeners:function(a){a.workspace.query&&
a.workspace.query.properties&&"true"===a.workspace.query.properties.properties["org.saiku.connection.scenario"]&&$(a.workspace.el).find(".query_scenario").hasClass("on")&&$(a.workspace.el).find("td.data").click(this.clicked_cell)},clicked_cell:function(a){a=$(a.target).hasClass("data")?$(a.target).find("div"):$(a.target);var b=a.attr("alt");a.attr("rel");b=$("\x3cinput type\x3d'text' value\x3d'"+b+"' /\x3e").keyup(this.check_input).blur(this.cancel_writeback);a.html("").append(b);b.focus()},check_input:function(a){13==
a.which?this.save_writeback(a):27!=a.which&&9!=a.which||this.cancel_writeback(a);return!1},save_writeback:function(a){a=$(a.target).closest("input");this.set({value:a.val(),position:a.parent().attr("rel")});this.save();var b=a.val();a.parent().text(b)},cancel_writeback:function(a){a=$(a.target).closest("input");a.parent().text(a.parent().attr("alt"))},parse:function(){this.query.run()},url:function(){return this.query.url()+"/cell/"+this.get("position")+"/"+this.get("value")}}),Query=Backbone.Model.extend({formatter:Settings.CELLSET_FORMATTER,
properties:null,initialize:function(a,b){_.extend(this,b);_.bindAll(this,"run");this.uuid="xxxxxxxx-xxxx-xxxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(a){var b=16*Math.random()|0;return("x"==a?b:b&3|8).toString(16)}).toUpperCase();this.model=_.extend({name:this.uuid},SaikuOlapQueryTemplate);a.cube&&(this.model.cube=a.cube);this.helper=new SaikuOlapQueryHelper(this);this.action=new QueryAction({},{query:this});this.result=new Result({limit:Settings.RESULT_LIMIT},{query:this});this.scenario=new QueryScenario({},
{query:this})},parse:function(a){this.id=this.uuid;a.name&&(this.uuid=this.id=a.name);this.model=_.extend(this.model,a);this.model.properties=_.extend({},Settings.QUERY_PROPERTIES,this.model.properties)},setProperty:function(a,b){this.model.properties[a]=b},getProperty:function(a){return this.model.properties[a]},run:function(a,b){var c=this;Saiku.ui.unblock();if("undefined"==typeof this.model.properties||!1!==this.model.properties["saiku.olap.query.automatic_execution"]||!1!==a&&void 0!==a&&null!==
a){this.workspace.unblock();$(this.workspace.el).find(".workspace_results_info").empty();this.workspace.trigger("query:run");this.result.result=null;var d=!1,e="Query Validation failed!",f=this.helper.model(),g;for(g in this.attributes){var h=this.attributes[g];if("PARAM"===g.substring(0,5)){var k=g.substring(5,g.size());f.parameters[k]=h}}"OLAP"==f.queryType&&("QUERYMODEL"==f.type?(g=0<Object.keys(f.queryModel.axes.COLUMNS.hierarchies).length,h=0<Object.keys(f.queryModel.axes.ROWS.hierarchies).length,
k="COLUMNS"==f.queryModel.details.axis&&0<f.queryModel.details.measures.length,h&&g&&k||(e=""),g||k||(e+='\x3cspan class\x3d"i18n"\x3eYou need to include at least one measure or a level on columns for a valid query.\x3c/span\x3e'),h||(e+='\x3cspan class\x3d"i18n"\x3eYou need to include at least one level on rows for a valid query.\x3c/span\x3e'),(g||k)&&h&&(d=!0)):"MDX"==f.type&&((d=f.mdx&&0<f.mdx.length)||(e='\x3cspan class\x3d"i18n"\x3eYou need to enter some MDX statement to execute.\x3c/span\x3e')));
d?(this.workspace.table.clearOut(),$(this.workspace.processing).html('\x3cspan class\x3d"processing_image"\x3e\x26nbsp;\x26nbsp;\x3c/span\x3e \x3cspan class\x3d"i18n"\x3eRunning query...\x3c/span\x3e [\x26nbsp;\x3ca class\x3d"cancel i18n" href\x3d"#cancel"\x3eCancel\x3c/a\x3e\x26nbsp;]').show(),this.workspace.adjust(),this.workspace.trigger("query:fetch"),Saiku.i18n.translate(),this.workspace.block('\x3cspan class\x3d"processing_image"\x3e\x26nbsp;\x26nbsp;\x3c/span\x3e \x3cspan class\x3d"i18n"\x3eRunning query...\x3c/span\x3e [\x26nbsp;\x3ca class\x3d"cancel i18n" href\x3d"#cancel"\x3eCancel\x3c/a\x3e\x26nbsp;]'),
...
Modal.extend({initialize:function(a,b){_.extend(this.options,{title:"Error"});this.reportedissue=a.issue;this.message="There has been an error creating a session:\x3cbr\x3e"+this.reportedissue},events:{"click a":"close"},dummy:function(){return!0},type:"info"}),SplashScreen=Backbone.View.extend({events:{"click .run_query":"run_query","click .run_dashboard":"run_dashboard"},run_query:function(){Saiku.tabs.add(new Workspace);return!1},run_dashboard:function(){(new DashboardModal).render().open();return!1},
...
"";return _.template(a)({})},setupPage:function(a){a=$(window).height();$("body").height(a);$(".tabs section").each(function(){$(this).height()});a=$("nav li.active a").attr("class");$("#"+a).fadeIn()},render:function(){$(this.el).html(this.template()).appendTo($("body"));var a=new License;Settings.BIPLUGIN5?a.fetch_license("api/api/license",function(a){"error"!==a.status&&"trial"!=a.data.get("licenseType")&&$(".enterprisetoggle").css("visibility","hidden")}):a.fetch_license("api/license/",function(a){"error"!==
a.status&&"trial"!=a.data.get("licenseType")&&$(".enterprisetoggle").css("visibility","hidden")});this.getNews();this.setupPage();$("nav li a").click(function(){var a=$(this).attr("class");$("nav li").removeClass("active");$(this).parent().addClass("active");$(".tabs section").hide();$("#"+a).fadeIn()});return this},remove:function(){$(this.el).remove()},caption:function(a){return"Home"},getNews:function(){var a=this;$.ajax({type:"GET",url:"http://meteorite.bi/news.json",async:!1,contentType:"application/json",
dataType:"jsonp",jsonpCallback:"jsonCallback",success:function(b){for(var c=0;c<b.item.length;c++)$(a.el).find("#news").append("\x3ch4 style\x3d'margin-left: 0.5%;color:#6D6E71;'\x3e"+b.item[c].title+"\x3c/h4\x3e\x3cstrong style\x3d'margin-left: 0.5%;color:#6D6E71;'\x3e"+b.item[c].date+"\x3c/strong\x3e\x3cbr/\x3e\x3cp style\x3d'color:#6D6E71;'\x3e"+b.item[c].body+"\x3c/p\x3e");console.dir(b.item[0].tid)},error:function(a){console.log(a.message)}})}}),SessionWorkspace=Backbone.Model.extend({initialize:function(a,
...
this.cube+"/hierarchies/"+encodeURIComponent(this.hierarchy)+"/levels/"+encodeURIComponent(this.level)}}),Plugin=Backbone.Model.extend({}),PluginCollection=Backbone.Collection.extend({model:Plugin,url:"info"}),License=Backbone.Model.extend({url:"api/license",initialize:function(){_.bindAll(this,"fetch_license")},fetch_license:function(a,b){this.fetch({success:function(a){b&&"function"===typeof b&&b({status:"success",data:a})},error:function(a){b&&"function"===typeof b&&b({status:"error",data:a})}})}}),
LicenseUserModel=Backbone.Model.extend({url:"api/license/users"}),LicenseUsersCollection=Backbone.Collection.extend({url:"api/license/users",model:LicenseUserModel}),Saiku={toolbar:{},tabs:new TabSet,splash:new SplashScreen,session:null,events:_.extend({},Backbone.Events),routers:[],ui:{block:function(a){$(".processing_message").html(a);$(".processing_message").removeClass("i18n_translated").addClass("i18n");Saiku.i18n.translate();$(".processing,.processing_container").show()},unblock:function(){$(".processing,.processing_container, .blockOverlay").hide();
...
c){var f=$(c).attr("id").split("-")[1];_.find(a.dataLevels,function(b,d){f===b.name.toLowerCase()?$(c).val(a.dataLevels[d].analyzerDateFormat):"yesterday"!==f&&"today"!==f||b.name!==a.name||_.isEmpty(a.dataLevels[d].analyzerDateFormat)||void 0===a.dataLevels[d].analyzerDateFormat||null===a.dataLevels[d].analyzerDateFormat||"TIME_DAYS"!==a.dataLevels[d].levelType||$(c).val(a.dataLevels[d].analyzerDateFormat)})}),$(c).find("input:radio").each(function(a,b){null!==$(b).val()&&void 0!==$(b).val()&&""!==
...
(function(a){var b;a:{try{document.createElement("$")}catch(c){b=c;break a}b=void 0}a.Base64||(a.Base64={encode:function(a){for(var c,f,g,h,k,l,m=0,n=a.length,s=Math.max,p="";m<n;){c=a.charCodeAt(m++)||0;f=a.charCodeAt(m++)||0;l=a.charCodeAt(m++)||0;if(255<s(c,f,l))throw b;g=c>>2&63;c=(c&3)<<4|f>>4&15;h=(f&15)<<2|l>>6&3;k=l&63;f?l||(k=64):h=k=64;p+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".charAt(g)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".charAt(c)+
"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".charAt(h)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".charAt(k)}return p}})})(this);
