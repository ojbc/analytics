...
wipeCurrentDatabase <- function(stagingConnection) {
  ...
  dbSendQuery(stagingConnection, "delete from BehavioralHealthEvaluation")
  dbSendQuery(stagingConnection, "delete from BehavioralHealthAssessment")
  dbSendQuery(stagingConnection, "delete from BookingCharge")
  dbSendQuery(stagingConnection, "delete from BookingArrest")
  dbSendQuery(stagingConnection, "delete from CustodyRelease")
  dbSendQuery(stagingConnection, "delete from CustodyStatusChangeCharge")
  dbSendQuery(stagingConnection, "delete from CustodyStatusChangeArrest")
  dbSendQuery(stagingConnection, "delete from CustodyStatusChange")
  dbSendQuery(stagingConnection, "delete from Booking")
  dbSendQuery(stagingConnection, "delete from Person")
  dbSendQuery(stagingConnection, "delete from Location")

  dbSendQuery(stagingConnection, "delete from Agency")
  dbSendQuery(stagingConnection, "delete from AssessmentCategoryType")
  dbSendQuery(stagingConnection, "delete from SupervisionUnitType")
  dbSendQuery(stagingConnection, "delete from BondStatusType")
  dbSendQuery(stagingConnection, "delete from BondType")
  dbSendQuery(stagingConnection, "delete from ChargeClassType")
  dbSendQuery(stagingConnection, "delete from DomicileStatusType")
  dbSendQuery(stagingConnection, "delete from Facility")
  dbSendQuery(stagingConnection, "delete from JurisdictionType")
  dbSendQuery(stagingConnection, "delete from LanguageType")
  dbSendQuery(stagingConnection, "delete from MedicaidStatusType")
  dbSendQuery(stagingConnection, "delete from MilitaryServiceStatusType")
  dbSendQuery(stagingConnection, "delete from PersonEthnicityType")
  dbSendQuery(stagingConnection, "delete from PersonRaceType")
  dbSendQuery(stagingConnection, "delete from PersonSexType")
  dbSendQuery(stagingConnection, "delete from ProgramEligibilityType")
  dbSendQuery(stagingConnection, "delete from SexOffenderStatusType")
  dbSendQuery(stagingConnection, "delete from TreatmentStatusType")
  dbSendQuery(stagingConnection, "delete from WorkReleaseStatusType")
  dbSendQuery(stagingConnection, "delete from TreatmentAdmissionReasonType")
